...
export function CotillionDance() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full pointer-events-none opacity-20 blur-3xl"
        style={{
          background: "radial-gradient(circle, rgba(255, 215, 0, 0.25) 0%, rgba(138, 43, 226, 0.15) 50%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            A traditional dance of elegance and grace. Meet the eight couples of the Court of Honor who share the floor in celebration of Glizlen’s 18th Birthday.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
          {couples.map((couple, i) => (
            <motion.div
              ...
              className="p-6 rounded-2xl relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
              style={{
            ...
            >
              ...
              <div className="flex flex-col gap-2 mt-2">
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-white/5 border border-white/5 group-hover:border-[#FFD700]/20 transition-colors">
                  <span className="text-xs text-white/50 uppercase tracking-wider font-semibold">Gentleman</span>
                  <span
                    style={{
                      fontFamily: "'Playfair Display', serif",
                      fontSize: "1.05rem",
                ...
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#FFD700]/5 border border-[#FFD700]/10 group-hover:border-[#FFD700]/30 transition-colors">
                  <span className="text-xs text-[#FFD700]/70 uppercase tracking-wider font-semibold">Lady</span>
                  <span
                    style={{
                      fontFamily: "'Playfair Display', serif",
                      fontSize: "1.05rem",
